...
const StudentTable = ({ students, onEdit, onDelete, onView, loading }) => {
  ...
  const filteredStudents = students.filter(student => {
    ...
    const matchesDepartment = !filterDepartment || student.department_name === filterDepartment;
    const matchesLevel = !filterLevel || student.current_level_value === parseInt(filterLevel);
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-600">Full Name</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {filteredStudents.map((student, index) => (
              <tr key={student.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm font-mono">{student.matric_no}</td>
                ...
                <td className="px-4 py-3 text-sm text-center">{student.current_level_value}</td>
